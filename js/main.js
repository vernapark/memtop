...
// Category icon mapping with images
const categoryIcons = {
...
// Get category icon (emoji or image)
...
function createCategorySection(category, videos) {
    ...
    // Removed category header - now each video shows its own category icon
    section.innerHTML = `
...
// Create a video card HTML - YouTube Style with Circular Category Icon
